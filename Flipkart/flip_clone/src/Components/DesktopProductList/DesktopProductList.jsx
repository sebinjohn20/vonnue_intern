...
function DesktopProductList() {
    ...
    const [filteredProducts, setFilteredProducts] = useState([]);
      ...
      const {selectedSort,selectedDiscounts,updateSort,updateDiscountFilter}=useFilter()
...
filtered=applySorting(filtered,selectedSort)
 setFilteredProducts(filtered)
  },[selectedSort,selectedDiscounts,products])
 ...
 {isDiscountOpen && (
  <div className='drop-down-box-container'>
    {discountOptions.map((option, index) => (
      <div className="single-item-container" key={index}>
        <label className='item-one' onClick={()=>updateDiscountFilter(option)}>
          <input 
            className='checkBox' 
            type="checkbox" 
  ...
  {filteredProducts.map((item, index) => (
    <div className="desktop-single-card-item-container" key={index}>
